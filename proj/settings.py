...
SECRET_KEY = 'django-insecure-sn3he5^nv-znxciik-+3=bx2#rplz2%i^v9syw!ni(5goq9)3f'
...
ADMIN_REORDER = [
    ...
    # Rename app
    {'app': 'auth', 'label': 'Usuaris i permisos'},
    {'app': 'batudes', 'label': 'Cacera'},

    # Reorder app models
    {'app': 'Cacera', 'models': ('Coto', 'Sector', 'Batuda')},
]
